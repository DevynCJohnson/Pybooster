...
override LIST_MAIN_DEPS::=aspell bsdmainutils bsdutils calc clang cloc colormake coreutils curl debianutils devscripts doschk dot enchant exuberant-ctags gcc global hunspell id-utils inkscape ispell libxml2-utils licensecheck llvm make meson moreutils ncc ninja-build pysassc python3-gi python3-pip python3-setuptools python3-wheel rename scss sloccount spell spellutils uuid wcalc wget xdg-utils xz-utils
