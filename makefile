...
override LIST_SCRIPT_PROGRAMS::=alphabetize_lines ampupcpu bin2hex bin2num bin2oct CamelCase char2num cleansystem genmathart getsysinfo hex2num holograph2str lslibfunc man2devhelp minifyxml num2bin num2char num2hex num2oct oct2num PascalCase pipebuf prettifyxml refreshgrub replaceoddchars save_file_times set_access_time str2holograph svgresizer termtest thumbnail-cleaner togglequotes unicalc webget win2unixlines
override LIST_PIP_DEPS::=autopep8 bandit bashate crimp cx-Freeze docformatter flake8 flake8-aaa flake8-alfred flake8-builtins flake8-coding flake8-comprehensions flake8-deprecated flake8-logging-format flake8-mypy flake8-pyi mccabe modulegraph modulegraph2 mypy mypy_extensions Pillow pyaml pycallgraph pycodestyle pydocstyle pyflakes pyinstaller pylint pylint-django radon uncalled vulture yamllint
override LIST_DEV_DEPS::=astyle binwalk bsdiff bsdiff cccc cgdb complexity cppcheck doxygen doxygen-gui flawfinder gdb geany geany-plugin-addons geany-plugin-automark geany-plugin-codenav geany-plugin-commander geany-plugin-ctags geany-plugin-defineformat geany-plugin-doc geany-plugin-extrasel geany-plugin-gendoc geany-plugin-insertnum geany-plugin-keyrecord geany-plugin-latex geany-plugin-lineoperations geany-plugin-lua geany-plugin-macro geany-plugin-miniscript geany-plugin-numberedbookmarks geany-plugin-overview geany-plugin-pairtaghighlighter geany-plugin-pg geany-plugin-pohelper geany-plugin-prettyprinter geany-plugin-prj geany-plugin-projectorganizer geany-plugin-shiftcolumn geany-plugin-spellcheck geany-plugin-tableconvert geany-plugin-treebrowser geany-plugin-vc geany-plugin-workbench geany-plugin-xmlsnippets git-cola git-extras git-flow git-gui gitlint gitstats glade jsonlint kwstyle ltrace mscgen optipng patchutils pmccabe pngcrush pscan psrecord python3-demjson qgit shc shellcheck splint strace uchardet undertaker universalindentgui vbindiff wamerican-insane xxdiff xxgdb yajl-tools
override LIST_MAIN_DEPS::=clang cloc colormake coreutils doschk exuberant-ctags gcc global id-utils libxml2-utils licensecheck llvm make moreutils python3-chardet python3-gi python3-logilab-common python3-pip python3-pytest python3-pytest-pep8 sloccount xdg-utils
