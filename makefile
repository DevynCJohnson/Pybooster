...
override LIST_DEV_DEPS::=astyle binwalk bsdiff bsdiff cccc cgdb complexity cppcheck doxygen doxygen-gui flawfinder gdb git-cola git-extras git-flow git-gui gitlint gitstats glade jsonlint kwstyle ltrace mscgen optipng patchutils pmccabe pngcrush pscan psrecord python3-demjson qgit shc shellcheck splint strace uchardet undertaker universalindentgui vbindiff wamerican-insane xxdiff xxgdb yajl-tools
...
override LIST_MAIN_DEPS::=clang cloc colormake coreutils devscripts doschk exuberant-ctags gcc global id-utils libxml2-utils licensecheck llvm make moreutils python3-chardet python3-gi python3-logilab-common python3-pip python3-pytest python3-pytest-pep8 python3-setuptools sloccount uuid xdg-utils
