...
override LIST_SCRIPT_PROGRAMS::=alphabetize_lines ampupcpu audio-hpss-spectrogram audio-melspectrogram audio-vocals-spectrogram audio-waveplot bin2hex bin2num bin2oct CamelCase char2num cleansystem deep_dreaming deep_dreaming_gaussian_pyramids findfont flipchars genmathart getsysinfo google_translate hex2num homoglyph2str lslibfunc lsmoduleparams machine_learning man2devhelp minifyxml num2bin num2char num2hex num2oct oct2num PascalCase pipebuf prettifyxml refreshgrub replaceoddchars save_file_times set_access_time setfiletimes str2homoglyph svgresizer termtest thumbnail-cleaner togglequotes unicalc webget win2unixlines
