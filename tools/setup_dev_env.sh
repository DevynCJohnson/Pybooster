...
install_deb_pkgs() {
    if [ -x "$(command -v apt-get)" ]; then
        ...
        apt-get --quiet --yes install apache2-doc bash-doc bison-doc clang-doc cpp-doc cppreference-doc-en-html ddd-doc dpdk-doc gcc-doc gdb-doc git-doc glibc-doc glibc-doc-reference gnome-devel-docs gstreamer1.0-doc libclutter-1.0-doc libclutter-gtk-1.0-doc libcogl-doc libglib2.0-doc libgtk-3-doc libgtksourceview-3.0-doc libomp-doc libpango1.0-doc llvm-doc make-doc python-numpy-doc python-setuptools-doc python3-doc
    else
