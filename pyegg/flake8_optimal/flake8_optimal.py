...
REGEX_NOTE = rgxcompile(r'# (DEBUG|DEPRECATED|FINISH|FIX|FIXME|REPAIR|TESTING|TODEBUG|TODO|TOMV|TORM|XXX):', flags=IGNORECASE)
REGEX_NOTE_CASE = rgxcompile(r'# (DEBUG|DEPRECATED|FINISH|FIX|FIXME|REPAIR|TESTING|TODEBUG|TODO|TOMV|TORM|XXX): ')
