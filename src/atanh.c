...
/**
@brief Return the area hyperbolic tangent of the input
@file atanh.c
@version 2018.11.11
...
@section COMPILE
gcc -Wall -Wextra -Wpedantic -O3 -Wl,-O3 -g0 -ggdb0 -s -fwhole-program -funroll-loops -ffunction-sections -fdata-sections -std=c11 -o ./atanh ./atanh.c && strip --remove-section=.note --remove-section=.comment --strip-debug --strip-unneeded ./atanh
