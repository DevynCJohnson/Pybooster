...
/**
@brief Return the area hyperbolic cosine of the input
@file acosh.c
@version 2018.10.02
...
@section COMPILE
gcc -Wall -Wextra -Wpedantic -O3 -Wl,-O3 -g0 -ggdb0 -s -fwhole-program -funroll-loops -ffunction-sections -fdata-sections -std=c11 -o ./acosh ./acosh.c && strip --remove-section=.note --remove-section=.comment --strip-debug --strip-unneeded ./acosh
