...
__all__: list = [
    ...
    r'REGULAR2SUBSCRIPT',
    r'SUBSCRIPT2REGULAR',
    r'REGULAR2SUPERSCRIPT',
    r'SUPERSCRIPT2REGULAR',
    r'MORSE_CODE',
    # CHARACTER LISTS #
    r'ARROWS',
    r'ASTROLOGY',
...
ASCII_BRAILLE_TEXT: str = ' !"#$%&\'()*+,-./0123456789:;<=>?@abcdefghijklmnopqrstuvwxyz[\\]^_'
BRAILLE_TEXT: str = r'⠀⠮⠐⠼⠫⠩⠯⠄⠷⠾⠡⠬⠠⠤⠨⠌⠴⠂⠆⠒⠲⠢⠖⠶⠦⠔⠱⠰⠣⠿⠜⠹⠈⠁⠃⠉⠙⠑⠋⠛⠓⠊⠚⠅⠇⠍⠝⠕⠏⠟⠗⠎⠞⠥⠧⠺⠭⠽⠵⠪⠳⠻⠘⠸'

REGULAR_TEXT: str = r'0123456789'
SUBSCRIPT_TEXT: str = r'₀₁₂₃₄₅₆₇₈₉'
SUPERSCRIPT_TEXT: str = r'⁰¹²³⁴⁵⁶⁷⁸⁹'
...
ASCII2BRAILLE: dict = str.maketrans(ASCII_BRAILLE_TEXT, BRAILLE_TEXT)
BRAILLE2ASCII: dict = str.maketrans(BRAILLE_TEXT, ASCII_BRAILLE_TEXT)
REGULAR2SUBSCRIPT: dict = str.maketrans(REGULAR_TEXT, SUBSCRIPT_TEXT)
SUBSCRIPT2REGULAR: dict = str.maketrans(SUBSCRIPT_TEXT, REGULAR_TEXT)
REGULAR2SUPERSCRIPT: dict = str.maketrans(REGULAR_TEXT, SUPERSCRIPT_TEXT)
SUPERSCRIPT2REGULAR: dict = str.maketrans(SUPERSCRIPT_TEXT, REGULAR_TEXT)
...
CHESS: tuple = (r'♔', r'♕', r'♖', r'♗', r'♘', r'♙', r'♚', r'♛', r'♜', r'♝', r'♞', r'♟', r'🨀', r'🨁', r'🨂', r'🨃', r'🨄', r'🨅', r'🨆', r'🨇', r'🨈', r'🨉', r'🨊', r'🨋', r'🨌', r'🨍', r'🨎', r'🨏', r'🨐', r'🨑', r'🨒', r'🨓', r'🨔', r'🨕', r'🨖', r'🨗', r'🨘', r'🨙', r'🨚', r'🨛', r'🨜', r'🨝', r'🨞', r'🨟', r'🨠', r'🨡', r'🨢', r'🨣', r'🨤', r'🨥', r'🨦', r'🨧', r'🨨', r'🨩', r'🨪', r'🨫', r'🨬', r'🨭', r'🨮', r'🨯', r'🨰', r'🨱', r'🨲', r'🨳', r'🨴', r'🨵', r'🨶', r'🨷', r'🨸', r'🨹', r'🨺', r'🨻', r'🨼', r'🨽', r'🨾', r'🨿', r'🩀', r'🩁', r'🩂', r'🩃', r'🩄', r'🩅', r'🩆', r'🩇', r'🩈', r'🩉', r'🩊', r'🩋', r'🩌', r'🩍', r'🩎', r'🩏', r'🩐', r'🩑', r'🩒', r'🩓')
